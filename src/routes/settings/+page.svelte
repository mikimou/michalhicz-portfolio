...
<svelte:head>
	<title>Michal Hicz Settings</title>
	<meta name="description" content="Michal Hicz Settings" />
</svelte:head>
    ...
    <div class="body">
        <div class="window">
            <center>
                ...
                <label for="mouse" class="drac-text drac-text-purple-cyan">Background mouse reactivity</label><br><br><br>
